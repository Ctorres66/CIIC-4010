...
public class Images {
	...
	// made new instance variable for new images we would like to add to the restaurant
	// it doesnt have to be 5 new things but im leaving it as 5 just in case we think of something to add later
    ...
    public static BufferedImage[] newStuff;
    public Images() {
        ...
        try {
            ...
            floor = ImageIO.read(getClass().getResourceAsStream("/Sheets/WoodFloor.jpg"));
            ...
            people[8] = ImageIO.read(getClass().getResourceAsStream("/Sheets/People/Lawyer2Male.png"));
            ...
            people[4] = ImageIO.read(getClass().getResourceAsStream("/Sheets/People/Weather_Reporter2Female.png"));
            people[9] = Images.tint(people[8], 1, 1, 5);// ANTi-V
            people[10] = Images.tint(people[8], 1, 5, 1);// Inspector
            ...
            newStuff[0] = burgerSpriteSheet.crop(303, 166, 117, 42); // onions (hopefully)
            newStuff[1] = ImageIO.read(getClass().getResourceAsStream("/Sheets/floor2.jpg"));//Kitchen floor
            arrow = ImageIO.read(getClass().getResourceAsStream("/Sheets/Arrow.jpg")); // arrow
            newStuff[3] =ImageIO.read(getClass().getResourceAsStream("/Sheets/timer.jpg")); //timer
            newStuff[4] = kitchenCounterSpriteSheet.crop(130, 12, 30, 52);
